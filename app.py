...
# Auto-create database only when using SQLite AND file doesn't exist.
# When DATABASE_URL is set (Supabase/PostgreSQL), skip this —
# the database is already seeded and TRUNCATE would wipe all data.
